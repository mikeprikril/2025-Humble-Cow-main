...
public class TuckAuto extends Command {
  ...
  public TuckAuto(ElevatorSubsystem m_elevator, ArmSubsytem m_arm) {
  ...
  public boolean isFinished() {
    return elevator.GetBottomLimitSwitch() == false && arm.GetTopLimitSwitch() == true;
  }
}
