...
public class MoveToL2 extends Command {
  ...
  public MoveToL2(ElevatorSubsystem m_elevator, ArmSubsytem m_arm, Joystick m_panel) {
  ...
  public void execute() {
    ...
    else if (arm.GetArmEncoderPosition() < Constants.ArmConstants.armFlat && elevator.GetElevatorEncoderPosition() > (Constants.ElevatorConstants.L2Height + Constants.ElevatorConstants.deadband)){
  ...
  public boolean isFinished() {
    return !panel.getRawButton(Constants.OperatorConstants.L2Button);
